...
import type { ComposableTraitsOraclePrice, ComposableTraitsOracleRewardTracker, PalletOracleAssetInfo, PalletOraclePrePrice, PalletOraclePrice, PalletOracleWithdraw } from '@composable/types/interfaces/oracle';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    ComposableTraitsDexStakingRewardPool: ComposableTraitsDexStakingRewardPool;
